            ...
            <div class="community-grid">
                ...
                <div class="board-column">
                    ...
                    <c:forEach var="post" items="${board}">
                        <div class="community-card <c:if test="${not empty postImage}">community-card-with-image</c:if>">
                            <c:if test="${not empty postImage}">
                                <img src="${postImage}" alt="${post.title}" class="community-image" />
                            </c:if>
