				...
				<div class="review-form-box">
					...
					<form id="reviewForm" method="post">
						...
						<div class="form-footer">
							...
							<button type="submit" id="addReview" data-user-id="${userId}"
								data-item-id="${itemId}" data-review-writer="${username}"
								data-orders-details-id="${ordersDetailsId}">등록</button>
						</div>
					</form>
				</div>
				<!-- 리뷰 목록 -->
				...
				<div class="info-box">
					<div class="meta-group">
						<div class="meta-left">
							...
							<div>
								구매 <span>${shop.counting.totalcount}</span>
							</div>
						</div>
