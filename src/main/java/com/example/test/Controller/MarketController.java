...
public class MarketController {
	...
	String uploadResource(@PathVariable Long roleId, @PathVariable Long userId, Market market,
			...
			@RequestParam(value = "resourceImage", required = false) MultipartFile resourceImage, Model model)
			throws Exception {
	...
	String updateResource(@PathVariable Long itemId, Market market, @RequestParam MultipartFile file, Model model)
			throws Exception {
	...
	public String buyResource(@PathVariable Long userId, @PathVariable Long itemId,
			@RequestBody List<ResourceShop> shop) throws Exception {
